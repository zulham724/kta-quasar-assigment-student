<template>
  <q-layout view="hHh Lpr fFf">
    ...
    <q-page-container v-if="post != null">
      <q-page>
        <q-item
          style="background-color:#009688;border-radius: 0px 0px 20px 20px;"
        >
          ...
          <q-item-section>
            <q-item-label class="text-white">
              {{ post.author_id.name}}</q-item-label
            >
            <q-item-label
              class="text-white text-body1 q-pt-md"
              v-html="post.body"
            ></q-item-label>
              ...
              <div class="row justify-between">
                <div class="col-4">
                  <span
                    ...
                    :style="`font-size:20px;color:${post.liked_count ? 'red' : '#BDBDBD'}`"
                    clickable  @click="post.liked_count ? dislike(post.id) : like(post.id)"
                  >
