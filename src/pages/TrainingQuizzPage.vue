...
export default {
  ...
  components: {
    ItemAnswerListComponent: () =>
      import("components/quiz/ItemAnswerListComponentTraining.vue")
  ...
  methods: {
    init() {
      this.$store
        .dispatch("Assigment/showSelectOptionsOnly", { assignmentId: this.assigment.id })
        .then(res => {
          ...
          // console.log(this.assigment);
          this.session = {
            questions: this.assigmentForSubmit.question_lists
          };
