<template>
  <div>
    ...
    >
      <div
        class="column"
        style="min-height:0px; height: -webkit-fill-available;"
      >
        <div class="col-4">
          <q-card
          ...
          >
            ...
            >
              ...
              <div class="text-weight-light" style="color:white">
                Semester {{ assigmentForSubmit.teacher.name }}
              </div>
            </q-card-section>
          </q-card>
        </div>
          ...
          >
            ...
            <q-item class="q-py-lg">
              <q-item-section>
                <q-item-label>
                  <div
                    class="text-subtitle text-weight-regular"
                    style="font-size:18px;color:#80CBC4"
                  >
                    Nilai
                  </div>
                </q-item-label>
                ...
                <q-item-label>
                  <div
                    class="text-subtitle text-weight-regular"
                    style="font-size:16px;color:#80CBC4"
                  >
                    Keren!!
                  </div>
                </q-item-label>
              ...
              <q-item-section>
                ...
                <q-item-label class="q-pa-sm text-center">
                  <q-btn
                    ...
                    round
                    size="64px"
                    :style="`background-color:${getResult.color};border:2px solid white`"
                  >
...
export default {
  ...
  computed: {
    ...
    getResult() {
      if (this.score == null)
        return {isTemporary:true, color: "#F2C94C", description: "Silahkan tunggu", name:'Tunggu' };
      else {
