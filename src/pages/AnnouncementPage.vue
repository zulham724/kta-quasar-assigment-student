                ...
                <div class="q-pa-xl" v-if="EchoNotification.items.data.length==0">
                    <q-card flat>
                        ...
                        <q-card-section class="text-center">
                            <div class="text-weight-medium" style="color:#009688">Belum Ada Pemberitahuan</div>
                            <div class="text-caption">Kerjakan soal atau ikut diskusi agar kamu mendapatkan pemberitahuan</div>
                        </q-card-section>
                        <q-card-section class="text-center">
                            <q-btn no-caps rounded flat style="background-color:#009688;color:white" @click="$router.push('/')">
                                Beranda
                            </q-btn>
                        </q-card-section>
                    </q-card>
