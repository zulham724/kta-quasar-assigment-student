        ...
        >
          <div class="col-4 q-pl-md" style="font-size:16px">
            ...
            >
              <span
                class="material-icons"
                style="color:#80CBC4;font-size:20px;padding-right:5px"
              >
                timer
              </span>
              1 : 25 : 49
        ...
        >
          ...
          <q-tab-panels v-model="tab" animated style="background-color:#009688">
            <q-tab-panel
              ...
              v-for="(question_list, n) in assigment.question_lists"
    ...
    >
      <div class="row full-width">
        ...
        <div
          ...
          clickable
          @click="questionListIndex++"
          v-if="questionListIndex < assigment.question_lists.length - 1"
        >
          <div
...
export default {
  ...
  created() {
    ...
    if (!this.assigment) this.$router.push({ name: "assigment" });
    else this.init();
  },
  mounted() {},
  computed: {
  ...
  methods: {
    init() {
      this.$store
        .dispatch("Assigment/show", { assignmentId: this.assigment.id })
        .then(res => {
            ...
            question_lists: [
              ...res.data.question_lists.map(item => {
                if (
                  ...
                  item.answer = { id: item.answer_lists[0].id, name: null };
                else item.answer = {};
                return item;
              })
            ]
