<template>
  <div>
    <div
      v-if="questionList.assigment_types[0].description  == 'selectoptions'"
      class="q-gutter-y-md"
    >
      <div
    ...
    <div class="q-py-none" v-if="questionList.assigment_types[0].description == 'textarea'">
      <q-input
        class="q-pa-sm"
        type="textarea"
        outlined
    ...
    <div class="q-py-none" v-if="questionList.assigment_types[0].description  == 'textfield'">
      <q-input
        class="q-pa-sm"
        outlined
        dense
