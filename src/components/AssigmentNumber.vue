    ...
    <q-card class="q-dialog-plugin" style="border-radius:15px;">
        ...
        <q-card-section class="text-center">
            <div class="row full-width">
                <div class="q-pa-sm q-mx-auto" v-for="(question_list, n) in assigmentForSubmit.question_lists" :key="question_list.id">
                    <div class="col-2 text-center q-pa-md cursor-pointer" @click="onOKClick(n) " :style="
...
export default {
    ...
    created() {
        // console.log("ntl");
        //console.log(this.assigmentForSubmit.question_lists[2].answer.name);
    },
    methods: {
        show() {
